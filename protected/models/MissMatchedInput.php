...
/**
 * This is the model class for table "miss_matched_input".
 *
 * The followings are the available columns in table 'miss_matched_input':
 ...
 */
class MissMatchedInput extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('file_id, fullname, msisdn, imsi, vendorid, status', 'required'),
			array('province_code, district_code, commune_code, village_code, status', 'numerical', 'integerOnly'=>true),
			...
			array('file_id, title, fullname, national_id, province_code, district_code, commune_code, village_code, location, dob, msisdn, imsi, vendorid, state, last_update, status', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return MissMatchedInput the static model class
	 */
